...
interface PrimaryInsuranceQuestionProps {
  item: {
    type: string;
    questionText: string;
    isRequired: boolean;
...
const PrimaryInsuranceQuestionEditor: React.FC<PrimaryInsuranceQuestionProps> = ({ item, onChange }) => {
...
export default PrimaryInsuranceQuestionEditor;